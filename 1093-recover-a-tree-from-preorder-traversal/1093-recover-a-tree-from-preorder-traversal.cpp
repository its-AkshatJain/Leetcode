 ...
 */
class Solution {
    int getVal(string &traversal, int& n, int &pos){
        int val = 0;
    ...
    int getDashLen(string &traversal, int& n, int &pos){
        int dash_len = 0;
    ...
    void buildTree(TreeNode* curr, int expected_dash_len, string& traversal, int& n, int& pos){
        if(pos == n) return;
